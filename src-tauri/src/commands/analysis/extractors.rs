...
use crate::commands::{FrameAnalysisData, QPGridData, MVGridData, PartitionGridData, PredictionModeGridData, TransformGridData, MotionVectorData};
...
pub(super) fn extract_avc_analysis(
    ...
    log::info!("extract_avc_analysis: Returning analysis for frame {} ({}x{})", frame_index, width, height);
    ...
    let prediction_mode_grid = bitvue_avc::extract_prediction_mode_grid(&nal_units, &sps)
        ...
        .map(|(coded_width, coded_height, block_w, block_h, modes)| {
            ...
            PredictionModeGridData { coded_width, coded_height, block_w, block_h, grid_w, grid_h, modes }
        });
...
pub(super) fn extract_hevc_analysis(
    ...
    log::info!("extract_hevc_analysis: Returning analysis for frame {} ({}x{})", frame_index, width, height);
...
pub(super) fn extract_vp9_analysis(
    ...
    log::info!("extract_vp9_analysis: Returning analysis for frame {} ({}x{})", frame_index, width, height);
...
pub(super) fn extract_vvc_analysis(
    ...
    log::info!("extract_vvc_analysis: Returning analysis for frame {} ({}x{})", frame_index, width, height);
...
pub(super) fn extract_av3_analysis(
    ...
    log::info!("extract_av3_analysis: Returning analysis for frame {} ({}x{})", frame_index, width, height);
