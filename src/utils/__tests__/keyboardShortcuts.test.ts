...
describe('matchesShortcut', () => {
  ...
  it('should match Ctrl key shortcut', () => {
    ...
    const shortcut = { key: 'o', ctrl: true, description: 'Test', action: () => {} };
  ...
  it('should match Meta key shortcut', () => {
    ...
    const shortcut = { key: 'o', meta: true, description: 'Test', action: () => {} };
  ...
  it('should match Shift key shortcut', () => {
    ...
    const shortcut = { key: 'A', shift: true, description: 'Test', action: () => {} };
  ...
  it('should match Alt key shortcut', () => {
    ...
    const shortcut = { key: 'Tab', alt: true, description: 'Test', action: () => {} };
...
describe('getShortcutDisplay', () => {
  ...
  it('should display arrow keys', () => {
    const leftShortcut = { key: 'ArrowLeft', description: 'Test', action: () => {} };
    const rightShortcut = { key: 'ArrowRight', description: 'Test', action: () => {} };
  ...
  it('should display Page Up/Down', () => {
    const pageUpShortcut = { key: 'PageUp', description: 'Test', action: () => {} };
    const pageDownShortcut = { key: 'PageDown', description: 'Test', action: () => {} };
