...
describe('FrameNavigationControls', () => {
  ...
  it('should call onFirstFrame when first button clicked', () => {
    ...
    render(<FrameNavigationControls {...defaultProps} onFirstFrame={handleFirst} />);
  ...
  it('should call onPrevFrame when previous button clicked', () => {
    ...
    render(<FrameNavigationControls {...defaultProps} onPrevFrame={handlePrev} />);
  ...
  it('should call onNextFrame when next button clicked', () => {
    ...
    render(<FrameNavigationControls {...defaultProps} onNextFrame={handleNext} />);
  ...
  it('should call onLastFrame when last button clicked', () => {
    ...
    render(<FrameNavigationControls {...defaultProps} onLastFrame={handleLast} />);
  ...
  it('should call onFrameChange when input changes', () => {
    ...
    render(<FrameNavigationControls {...defaultProps} onFrameChange={handleChange} />);
...
describe('FrameNavigationControls edge cases', () => {
  ...
  it('should handle last frame', () => {
    render(<FrameNavigationControls {...defaultProps} currentFrameIndex={99} totalFrames={100} />);
  ...
  it('should handle single frame', () => {
    render(<FrameNavigationControls {...defaultProps} currentFrameIndex={0} totalFrames={1} />);

    expect(screen.getByRole('spinbutton')).toHaveValue(0);
  });

  it('should handle large frame numbers', () => {
    render(<FrameNavigationControls {...defaultProps} currentFrameIndex={9999} totalFrames={10000} />);
  ...
  it('should validate input range', () => {
    const handleChange = vi.fn();
    render(<FrameNavigationControls {...defaultProps} totalFrames={100} onFrameChange={handleChange} />);
