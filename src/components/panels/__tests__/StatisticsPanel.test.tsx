...
// Mock data
const mockFrames = [
  { frame_index: 0, frame_type: 'I', size: 50000, key_frame: true, pts: 0, poc: 0, display_order: 0, coding_order: 0 },
  { frame_index: 1, frame_type: 'P', size: 30000, ref_frames: [0], key_frame: false, pts: 1, poc: 1, display_order: 1, coding_order: 1 },
  { frame_index: 2, frame_type: 'P', size: 35000, ref_frames: [0], key_frame: false, pts: 2, poc: 2, display_order: 2, coding_order: 2 },
  { frame_index: 3, frame_type: 'B', size: 20000, ref_frames: [1, 2], key_frame: false, pts: 3, poc: 3, display_order: 3, coding_order: 3 },
];
...
describe('StatisticsPanel calculations', () => {
  it('should count I-frames correctly', () => {
    const mockIFrameData = [
      { frame_index: 0, frame_type: 'I', size: 50000, key_frame: true, pts: 0, poc: 0, display_order: 0, coding_order: 0 },
      { frame_index: 5, frame_type: 'I', size: 60000, key_frame: true, pts: 5, poc: 5, display_order: 5, coding_order: 5 },
    ];
  ...
  it('should calculate average frame size', () => {
    const mockAvgData = [
      { frame_index: 0, frame_type: 'I', size: 50000, key_frame: true, pts: 0, poc: 0, display_order: 0, coding_order: 0 },
      { frame_index: 1, frame_type: 'P', size: 30000, key_frame: false, pts: 1, poc: 1, display_order: 1, coding_order: 1 },
    ];
