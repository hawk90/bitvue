...
describe('TimelineFilmstrip', () => {
  ...
  it('should display frame thumbnails', () => {
    ...
    const thumbnails = document.querySelectorAll('.timeline-thumb, .filmstrip-thumb');
  ...
  it('should show frame numbers', () => {
    ...
    expect(screen.queryByText(/0/) || screen.queryByText(/1/)).toBeInTheDocument();
  });
...
describe('TimelineFilmstrip visual features', () => {
  ...
  it('should show frame type indicators', () => {
    ...
    const timelineBars = document.querySelectorAll('.timeline-bar-i, .timeline-bar-p, .timeline-bar-b');
