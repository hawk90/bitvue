...
vi.mock('../TimelineFilmstrip', () => ({
  TimelineFilmstrip: ({ frames, className, viewMode, filmstripCollapsed }: any) => (
...
describe('FilmstripPanel', () => {
  ...
  it('should handle single frame', () => {
    const singleFrame = [{ frame_index: 0, frame_type: 'I', size: 50000, poc: 0 }];
...
describe('FilmstripPanel integration', () => {
  it('should update when frames prop changes', () => {
    const { rerender } = render(
      <FilmstripPanel frames={[{ frame_index: 0, frame_type: 'I', size: 50000, poc: 0 }]} />
    );
