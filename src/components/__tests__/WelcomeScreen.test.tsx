...
describe('WelcomeScreen', () => {
  ...
  it('should render welcome content', () => {
    render(<WelcomeScreen onOpenFile={mockOnOpenFile} loading={false} error={null} />);
  ...
  it('should show loading state', () => {
    render(<WelcomeScreen onOpenFile={mockOnOpenFile} loading={true} error={null} />);
  ...
  it('should show error state', () => {
    render(<WelcomeScreen onOpenFile={mockOnOpenFile} loading={false} error="Failed to open file" />);
