...
export const TimelineThumbnails = forwardRef<HTMLDivElement, TimelineThumbnailsProps>(
  ({ frames, highlightedFrameIndex, onMouseDown, onMouseMove, onMouseLeave, onKeyDown, onFrameRefsChange }, ref) => {
      ...
      {frames.map((frame, idx) => {
        ...
        return (
          <div
            ...
            ref={(el) => { internalFrameRefs.current[idx] = el; }}
