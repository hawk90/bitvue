...
// `electron/main.ts`'s `ipcMain.handle` channel names by hand — there are only 3 today, plus
// one main-to-renderer push (`bitvue:sidecar-restarted`, see `onSidecarRestarted` below).
//
