...
impl BitvueApp {
    pub fn new(_cc: &eframe::CreationContext<'_>) -> Self {
        ...
        let mut app = Self {
            ...
            bytecache_worker: ByteCacheWorker::new().expect("Failed to create ByteCache worker"),
            export_worker: ExportWorker::new().expect("Failed to create export worker"),
            config_worker: ConfigWorker::new().expect("Failed to create config worker"),
