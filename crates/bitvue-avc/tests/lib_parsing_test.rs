...
fn test_parse_avc_quick_multiple_sps() {
    let data = [
        ...
        // Second SPS
        0x00, 0x00, 0x00, 0x01,
        0x67, 0x42, 0x00, 0x1E, 0x8D, 0x04, 0x08, 0x08, 0x00, 0x00, 0x00, 0x00,
    ];
...
fn test_parse_avc_quick_idr_slice() {
    let data = [
        ...
        0x68, 0x04, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x01,
        0x65, 0x80, 0x40, 0x04, 0x00, 0x00, 0x00,
    ];
...
fn test_parse_avc_quick_mixed_nal_types() {
    let data = [
        ...
        0x00, 0x00, 0x00, 0x01, 0x67, 0x42, 0x00, 0x1E, 0x8B, 0x04, 0x04, 0x04, 0x00, 0x00, 0x00, 0x00,  // SPS
    ];
