//! Foundations AVS3 Graph Future Plugin Lock #003: Frame Identity Contract
//! Subtask: S.T0-2.AVS3.Foundations.Graph.impl.future_plugin_lock.003
...
impl GraphState {
    ...
    fn add_frame(&mut self, f: GraphFrame) {
        self.frames.push(f);
    }
    fn get_frame(&self, display_idx: u64) -> Option<&GraphFrame> {
...
#[test]
fn test_empty_state() {
    assert!(GraphState::new().frames.is_empty());
}
#[test]
