...
use bitvue_core::export::{
    ...
    EvidenceBundleManifest, ExportSummary, FrameExportRow, GuardEvalContext, OverlayExportData,
...
use bitvue_core::parity_harness::{
    EntityRef, OrderType, ProbeOutcome, SelectionSnapshot, ViewportState,
};
...
fn test_create_diff_heatmap_export() {
    use bitvue_core::diff_heatmap::{DiffHeatmapData, DiffMode};
