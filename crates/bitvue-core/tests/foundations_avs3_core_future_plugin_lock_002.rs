...
//! Foundations AVS3 Core Future Plugin Lock #002: Frame Identity Contract
//! Subtask: S.T0-2.AVS3.Foundations.Core.impl.future_plugin_lock.002
...
impl CoreState {
    ...
    fn add_frame(&mut self, f: CoreFrame) {
        self.frames.push(f);
    }
    fn get_frame(&self, display_idx: u64) -> Option<&CoreFrame> {
...
#[test]
fn test_empty_state() {
    assert!(CoreState::new().frames.is_empty());
}
#[test]
