...
export const KEYBOARD_SHORTCUTS: ShortcutCategory[] = [
  {
    ...
    shortcuts: [
      ...
      { key: "[", description: "Previous I-frame" },
      { key: "]", description: "Next I-frame" },
      {
        key: "ArrowLeft",
        ctrl: true,
        meta: true,
      ...
      { key: "g", ctrl: true, meta: true, description: "Go to frame..." },
      { key: "f", ctrl: true, meta: true, description: "Go to frame..." },
      { key: "PageUp", description: "Previous 10 frames" },
      { key: "PageDown", description: "Next 10 frames" },
    ],
  },
  {
    name: "Playback",
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { key: "F11", description: "OS fullscreen", action: () => {} },
      {
        key: "Escape",
        description: "Exit fullscreen / deselect",
        action: () => {},
      },
      { key: "y", description: "Toggle Y channel", action: () => {} },
      { key: "u", description: "Toggle U channel", action: () => {} },
      { key: "v", description: "Toggle V channel", action: () => {} },
  ...
  },
  {
    name: "Application",
    shortcuts: [
      { key: "o", ctrl: true, meta: true, description: "Open file" },
      { key: "w", ctrl: true, meta: true, description: "Close file" },
      { key: "r", ctrl: true, meta: true, description: "Reload file" },
      { key: "e", ctrl: true, meta: true, description: "Export dialog" },
      { key: "s", ctrl: true, meta: true, description: "Save frame as PNG" },
      { key: "z", ctrl: true, meta: true, description: "Undo selection" },
      { key: "c", ctrl: true, meta: true, description: "Copy block info" },
