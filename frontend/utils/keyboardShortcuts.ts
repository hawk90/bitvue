...
export const KEYBOARD_SHORTCUTS: ShortcutCategory[] = [
  ...
  },
  {
    name: "Application",
    shortcuts: [
      { key: "o", ctrl: !isMac(), meta: isMac(), description: "Open file" },
      { key: "w", ctrl: !isMac(), meta: isMac(), description: "Close file" },
      { key: "r", ctrl: !isMac(), meta: isMac(), description: "Reload file" },
      { key: "e", ctrl: !isMac(), meta: isMac(), description: "Export dialog" },
      {
        key: "s",
        ctrl: !isMac(),
        meta: isMac(),
        description: "Save frame as PNG",
      },
      {
        key: "z",
        ctrl: !isMac(),
