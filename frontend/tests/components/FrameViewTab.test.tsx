...
describe('FrameViewTab', () => {
  ...
  it('should render frame index', () => {
    ...
    const frameIndexLabel = Array.from(labelElements).find(el => el.textContent === 'Frame Index:');
  ...
  it('should render PTS when available', () => {
    ...
    const labelElements = container.querySelectorAll('.frame-info-label');
    const ptsLabel = Array.from(labelElements).find(el => el.textContent === 'PTS:');
  ...
  it('should not render temporal ID when undefined', () => {
    ...
    const hasTemporalLabel = Array.from(temporalLabels).some(el => el.textContent === 'Temporal ID:');
  ...
  it('should not render display order when undefined', () => {
    ...
    const hasDisplayLabel = Array.from(displayLabels).some(el => el.textContent === 'Display Order:');
  ...
  it('should not render coding order when undefined', () => {
    ...
    const hasCodingLabel = Array.from(codingLabels).some(el => el.textContent === 'Coding Order:');
  ...
  it('should not render reference frames list when empty', () => {
    ...
    const hasRefLabel = Array.from(refLabels).some(el => el.textContent === 'Ref Frames:');
  ...
  it('should render note about parser integration', () => {
    ...
    expect(screen.getByText(/Full bitstream data available after parser integration/)).toBeInTheDocument();
  });
  ...
  it('should handle different frame types', () => {
    const frameTypes: Array<'I' | 'P' | 'B' | 'Unknown'> = ['I', 'P', 'B', 'Unknown'];
