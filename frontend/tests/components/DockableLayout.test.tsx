...
describe('DockableLayout', () => {
  ...
  it('should render left sidebar with tabs', () => {
    ...
    const tabTitles = tabs.filter(tab => tab.className.includes('sidebar-tab'));
  ...
  it('should switch between left sidebar tabs', () => {
    ...
    const panel2Tab = Array.from(tabs).find(tab => tab.textContent === 'Panel 2');
