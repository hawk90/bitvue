...
describe("ZoomControls", () => {
  ...
  it("should call onZoomIn when zoom in button clicked", () => {
    ...
    const buttons = screen.getAllByRole("button");
    const zoomInButton = buttons.find((b) =>
      b.querySelector(".codicon-zoom-in"),
    );
    if (zoomInButton) {
  ...
  it("should call onZoomOut when zoom out button clicked", () => {
    ...
    const buttons = screen.getAllByRole("button");
    const zoomOutButton = buttons.find((b) =>
      b.querySelector(".codicon-zoom-out"),
    );
    if (zoomOutButton) {
  ...
  it("should call onResetZoom when reset button clicked", () => {
    ...
    const resetButton = buttons.find((b) =>
      b.querySelector(".codicon-screen-normal"),
    );
    if (resetButton) {
