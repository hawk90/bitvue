...
import FrameSizesView, { SizeMetrics } from '@/components/Filmstrip/views/FrameSizesView';
...
describe('FrameSizesView', () => {
  ...
  it('should mark current frame as selected', () => {
    ...
    const selectedBar = document.querySelector('[data-frame-index="0"].selected');
...
describe('FrameSizesView bitrate curve', () => {
  ...
  it('should render polyline for bitrate curve', () => {
    ...
    const polyline = document.querySelector('.frame-sizes-line-chart polyline');
...
describe('FrameSizesView moving average', () => {
  ...
  it('should have correct stroke for moving average', () => {
    ...
    const polylines = document.querySelectorAll('.frame-sizes-line-chart polyline');
...
describe('FrameSizesView edge cases', () => {
  ...
  it('should handle single frame', () => {
    const props = {
      ...defaultProps,
      frames: [{ frame_index: 0, frame_type: 'I', size: 50000, poc: 0 }] as FrameInfo[],
    };
...
describe('FrameSizesView React.memo', () => {
  ...
  it('should re-render when currentFrameIndex changes', () => {
    ...
    const selectedBar = document.querySelector('[data-frame-index="2"].selected');
    expect(selectedBar).toBeInTheDocument();
  ...
  it('should re-render when sizeMetrics change', () => {
    ...
    rerender(<FrameSizesView {...defaultProps} sizeMetrics={newSizeMetrics} />);
