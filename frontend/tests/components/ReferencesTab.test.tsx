...
describe("ReferencesTab edge cases", () => {
  it("should handle null current frame", () => {
    render(<ReferencesTab currentFrame={null} frames={[]} />);
  ...
  it("should show no references message for keyframes", () => {
    ...
    render(<ReferencesTab currentFrame={keyframe} frames={[keyframe]} />);
  ...
  it("should handle empty ref_frames array", () => {
    ...
    render(<ReferencesTab currentFrame={frame} frames={[frame]} />);
  ...
  it("should handle missing reference frame data", () => {
    ...
    render(
      <ReferencesTab currentFrame={currentFrame} frames={[currentFrame]} />,
    );
  ...
  it("should handle missing pts in reference frames", () => {
    ...
    render(<ReferencesTab currentFrame={currentFrame} frames={frames} />);
