...
const mockFrames: FrameInfo[] = [
  ...
  { frame_index: 3, frame_type: 'B', size: 25000, poc: 3, temporal_id: 1, ref_frames: [1, 4] },
  { frame_index: 4, frame_type: 'P', size: 35000, poc: 4, temporal_id: 0, ref_frames: [0] },
];
...
describe('BPyramidView', () => {
  ...
  it('should mark current frame as selected', () => {
    ...
    const selectedCircle = document.querySelector('[data-frame-index="0"].selected');
...
describe('BPyramidView temporal levels', () => {
  it('should organize frames by temporal_id', () => {
    ...
    const level0Circles = document.querySelectorAll('.bpyramid-level-row:nth-child(2) .bpyramid-frame-circle');
    const level1Circles = document.querySelectorAll('.bpyramid-level-row:nth-child(1) .bpyramid-frame-circle');
...
describe('BPyramidView reference arrows', () => {
  ...
  it('should render SVG overlay when arrows exist', () => {
    vi.mocked(usePreRenderedArrows).mockReturnValue({
      allArrowData: [
        { sourceFrameIndex: 2, targetFrameIndex: 0, pathData: 'M0,0 L10,10', color: '#4444ff' }
      ],
      svgWidth: 1000,
    });
...
describe('BPyramidView frame circles', () => {
  ...
  it('should handle current frame selection change', () => {
    ...
    const previouslySelected = document.querySelector('[data-frame-index="0"].selected');
