...
describe("PlaceholderPanel", () => {
  ...
  it("should render icon", () => {
    render(<PlaceholderPanel title="Test Panel" icon="symbol-boolean" />);
  ...
  it("should render without description", () => {
    render(<PlaceholderPanel title="Test Panel" icon="test" />);
...
describe("PlaceholderPanel variants", () => {
  it("should be used for BitViewPanel", () => {
    ...
    expect(
      screen.getByText("Binary/bit-level syntax element display"),
    ).toBeInTheDocument();
  });
