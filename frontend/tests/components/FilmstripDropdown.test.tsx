...
describe('FilmstripDropdown', () => {
  ...
  it('should render with current view label', () => {
    render(<FilmstripDropdown displayView="thumbnails" onViewChange={mockOnViewChange} />);
  ...
  it('should close dropdown when clicking outside', () => {
    render(
      <FilmstripDropdown displayView="thumbnails" onViewChange={mockOnViewChange} />
    );
  ...
  it('should mark active view', () => {
    ...
    const activeButton = Array.from(thumbnailsButtons).find(btn =>
  ...
  it('should use stable callbacks (useCallback optimization)', () => {
    ...
    rerender(<FilmstripDropdown displayView="thumbnails" onViewChange={mockOnViewChange} />);
