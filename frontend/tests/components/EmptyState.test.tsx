...
import { EmptyState, NoFileLoaded, NoFramesSelected, NoSearchResults, NoReferenceFrames, PanelEmptyState } from '@/components/common/EmptyState';
...
describe('NoFileLoaded', () => {
  it('should render with open file action', () => {
    ...
    expect(screen.getByText('Open a video bitstream file to begin analysis')).toBeInTheDocument();
...
describe('NoFramesSelected', () => {
  it('should render correctly', () => {
    ...
    expect(screen.getByText('Select a frame to view detailed information')).toBeInTheDocument();
  });
});
...
describe('NoReferenceFrames', () => {
  it('should render correctly', () => {
    ...
    expect(screen.getByText('This frame does not reference any other frames')).toBeInTheDocument();
  });
});
...
describe('PanelEmptyState', () => {
  it('should render with panel name', () => {
    ...
    expect(screen.getByText('Load a file to view this panel')).toBeInTheDocument();
  });
});
