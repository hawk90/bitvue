...
describe('ReferenceLinesOverlay', () => {
  ...
  it('should render one path and one arrow per expansion info', () => {
    const containerRef = { current: document.createElement('div') };
    const { container } = render(
      <ReferenceLinesOverlay expansionInfo={mockExpansionInfo} containerRef={containerRef} />
    );
  ...
  it('should apply correct styles to SVG', () => {
    ...
    const svg = container.querySelector('svg.reference-lines-overlay') as HTMLElement;
  ...
  it('should handle multiple arrows to same target', () => {
    ...
    const { container } = render(
      <ReferenceLinesOverlay expansionInfo={multiArrowInfo} containerRef={containerRef} />
    );
