...
describe('BookmarksPanel', () => {
  ...
  it('should display correct bookmark count', () => {
    const mockBookmarks = [
      { id: 'b1', frameIndex: 1, frameType: 'I', poc: 0, description: 'B1', timestamp: Date.now() },
      { id: 'b2', frameIndex: 2, frameType: 'P', poc: 1, description: 'B2', timestamp: Date.now() },
      { id: 'b3', frameIndex: 3, frameType: 'B', poc: 2, description: 'B3', timestamp: Date.now() },
    ];
    localStorage.setItem('bitvue-bookmarks', JSON.stringify(mockBookmarks));
