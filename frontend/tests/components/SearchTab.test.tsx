...
describe('SearchTab', () => {
  ...
  it('should call onClearSearch when clear clicked', () => {
    ...
    render(<SearchTab {...defaultProps} searchQuery="test" onClearSearch={handleClear} />);
  ...
  it('should display result count', () => {
    render(<SearchTab {...defaultProps} searchQuery="I" searchResults={[0, 5]} />);

    expect(screen.getByText(/Found 2 results/)).toBeInTheDocument();
  });

  it('should display singular result count', () => {
    render(<SearchTab {...defaultProps} searchQuery="I" searchResults={[0]} />);
...
describe('SearchTab results', () => {
  ...
  it('should show PTS value in results', () => {
    render(<SearchTab {...defaultProps} searchQuery="0" searchResults={[0]} />);
  ...
  it('should highlight current frame in results', () => {
    render(<SearchTab {...defaultProps} currentFrameIndex={0} searchQuery="0" searchResults={[0]} />);
...
describe('SearchTab empty states', () => {
  it('should show no results message when query matches nothing', () => {
    render(<SearchTab {...defaultProps} searchQuery="xyz" searchResults={[]} />);
...
describe('SearchTab interactions', () => {
  ...
  it('should clear search when clear button clicked', () => {
    ...
    render(<SearchTab {...defaultProps} searchQuery="test" onClearSearch={handleClear} onSearchChange={handleChange} />);
