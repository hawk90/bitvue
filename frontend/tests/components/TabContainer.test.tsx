...
describe("TabContainer", () => {
  ...
  it("should render all tabs", () => {
    render(
      <TabContainer tabs={mockTabs} activeTab="tab1" onTabChange={vi.fn()} />,
    );
  ...
  it("should mark active tab", () => {
    render(
      <TabContainer tabs={mockTabs} activeTab="tab2" onTabChange={vi.fn()} />,
    );
  ...
  it("should apply variant classes", () => {
    ...
    expect(
      container.querySelector(".tab-container-compact"),
    ).toBeInTheDocument();
  });
  ...
  it("should apply position classes", () => {
    ...
    expect(
      containerLeft.querySelector(".tab-container-left"),
    ).toBeInTheDocument();
  });
  ...
  it("should not render tabs when empty array", () => {
    const { container } = render(
      <TabContainer tabs={[]} activeTab="" onTabChange={vi.fn()} />,
    );
