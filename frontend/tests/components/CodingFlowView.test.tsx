...
describe("CodingFlowView", () => {
  ...
  it("displays codec-specific features for AV1", () => {
    render(<CodingFlowView frame={mockFrame} codec="av1" />);
  ...
  it("displays codec-specific features for VVC", () => {
    render(<CodingFlowView frame={mockFrame} codec="vvc" />);
  ...
  it("handles null frame gracefully", () => {
    const { container } = render(<CodingFlowView frame={null} codec="hevc" />);
