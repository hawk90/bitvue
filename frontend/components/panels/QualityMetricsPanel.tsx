 ...
 *
 * PSNR/SSIM/VMAF visualization with heatmap overlays
 * Per-block metric display with color scaling
 *
        ...
        <div className="border rounded p-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-2 text-sm bg-gray-100 hover:bg-gray-200 rounded flex-1"
            >
              Select File...
            </button>
          </div>
